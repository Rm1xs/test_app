...
class CameraFormPortrait extends StatefulWidget {
  CameraFormPortrait({Key? key, required this.camera}) : super(key: key);

  VideoPlayerController camera;

  @override
  State<CameraFormPortrait> createState() => _CameraFormState();
}

class _CameraFormState extends State<CameraFormPortrait> {
  @override
